...
from pyspark.sql.types import StructType, StructField, LongType, StringType, DateType, TimestampType, ShortType, IntegerType
...
class new:
    ...
    def __init__(self):
        ...
        self.target_table = "cdd_raw_qpromo_flr_performance"
        self.path = "/user/svc_uk_cust_rdl/sourceFiles/ftdw/QPROMO/QPROMO_vw_ix_flr_performance.csv"
    ...
    def new_Schema():
        new_Schema = StructType([
			...
			StructField("dbparentfloorplankey", IntegerType(), True),
		])
        return new_Schema
